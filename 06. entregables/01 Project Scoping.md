...
2. Unsupervised clustering algorithms to determine groups of vehicles in certain arcs and hours of the day, this it is possible if we could obtain additional information about the vehicles
